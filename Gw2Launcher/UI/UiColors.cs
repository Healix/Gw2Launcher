...
namespace Gw2Launcher.UI
{
    public static class UiColors
    {
        ...
        public enum Colors : short
        {
            ...
            AccountLoginRewardBackColor = 120,
            AccountLoginRewardText = 121,
            AccountLoginRewardTextOutline = 122,
            AccountLoginRewardBorder = 123,
            AccountLoginRewardRarityFine = 124,
            AccountLoginRewardRarityMasterwork = 125,
        ...
        public static bool SupportsAlpha(Colors c)
        {
            switch (c)
            {
                ...
                case Colors.AccountLoginRewardBackColor:
                case Colors.AccountLoginRewardBorder:
                case Colors.AccountLoginRewardText:
                case Colors.AccountLoginRewardTextOutline:
                case Colors.AccountLoginRewardRarityAscended:
                case Colors.AccountLoginRewardRarityExotic:
                case Colors.AccountLoginRewardRarityFine:
                case Colors.AccountLoginRewardRarityMasterwork:
                case Colors.AccountLoginRewardRarityRare:
