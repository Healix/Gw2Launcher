...
namespace Gw2Launcher.Windows.Dialogs
{
    public class SaveFolderDialog : FileDialog
    {
        public override System.Windows.Forms.DialogResult ShowDialog(System.Windows.Forms.IWin32Window owner)
        {
            var f = (FileDialogNative.IFileSaveDialog)new FileDialogNative.FileSaveDialogRCW();
            try
            {
                f.SetOptions(FileDialogNative.FOS.FOS_FORCEFILESYSTEM | FileDialogNative.FOS.FOS_NOTESTFILECREATE);
                f.SetFileNameLabel("Folder &name");

                base.Filter = "|\\";

                return base.ShowDialog(owner, f);
            }
            finally
            {
    ...
    public class OpenFolderDialog : FileDialog
    {
        public override System.Windows.Forms.DialogResult ShowDialog(System.Windows.Forms.IWin32Window owner)
        {
            var f = (FileDialogNative.IFileOpenDialog)new FileDialogNative.FileOpenDialogRCW();
            try
            {
                f.SetOptions(FileDialogNative.FOS.FOS_FORCEFILESYSTEM | FileDialogNative.FOS.FOS_PICKFOLDERS);
    ...
    public abstract class FileDialog
    {
        ...
        public void SetPath(string path, bool lastAsFilename)
        {
            ...
            if (di != null)
            {
                this.InitialDirectory = di.FullName;
                if (di.FullName.Length < path.Length)
                    this.FileName = path.Substring(di.FullName.Length + 1);
                else
                    this.FileName = null;
            }
            else
        ...
        public abstract System.Windows.Forms.DialogResult ShowDialog(System.Windows.Forms.IWin32Window owner);
    }
    ...
    static class FileDialogNative
    {
        ...
        internal interface IFileOpenDialog : IFileDialog
        {
            ...
            void AddPlace([In, MarshalAs(UnmanagedType.Interface)] IShellItem psi, IntPtr fdcp);
